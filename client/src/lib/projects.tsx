...
export const projects: Project[] = [
  ...
  },
  {
    ...
    subtitle: { fr: "Casquettes Premium Durables", en: "Premium Sustainable Caps" },
    category: { fr: "E-commerce", en: "E-commerce" },
    result: {
      fr: "Boutique de casquettes premium avec UX optimisée",
      en: "Premium cap store with optimized UX",
    },
    year: "2024",
    ...
    description: {
      fr: "Création d'une boutique e-commerce premium spécialisée dans les casquettes durables. Design moderne, UX optimisée et stratégie marketing complète.",
      en: "Creation of a premium e-commerce store specializing in sustainable caps. Modern design, optimized UX and complete marketing strategy.",
    },
    overviewHighlights: [
      { fr: "100% matières recyclées", en: "100% recycled materials" },
      { fr: "387L d'eau économisés par casquette", en: "387L water saved per cap" },
      { fr: "Expédition sans plastique", en: "Plastic-free shipping" },
    ],
    metrics: [
      { value: "+187%", label: { fr: "Taux de conversion", en: "Conversion rate" } },
      { value: "+245%", label: { fr: "Trafic organique", en: "Organic traffic" } },
      { value: "67€", label: { fr: "Panier moyen", en: "Average basket" } },
      { value: "73%", label: { fr: "Taux de rétention", en: "Retention rate" } },
    ],
    showcases: [
      {
